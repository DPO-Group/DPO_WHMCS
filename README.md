...
## Installation
Please navigate to the [releases page](https://github.com/DirectPay-Online/DPO_WHMCS/releases), download the latest release (v1.0.2) and unzip. You will then be able to follow the integration guide which is included in the zip.
